...
The most up-to date version of this document is available at:
    ...
    https://github.com/ruclassic/rucoin-electrum-server/blob/master/HOWTO.md
...
We will download the latest git snapshot for Electrum to configure and install it:
    ...
    $ cd ~
    $ git clone https://github.com/ruclassic/rucoin-electrum-server.git
    $ cd electrum-ruc-server
    $ sudo configure
